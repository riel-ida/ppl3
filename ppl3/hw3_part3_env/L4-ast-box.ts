...
export interface ThunkExp4 {tag: "ThunkExp4"; arg: CExp4; env: Env; }; //Added
...
export const makeThunkExp4 = (arg: CExp4, env: Env): ThunkExp4 =>
    ({tag: "ThunkExp4", arg: arg, env: env}); //Added
...
export const isThunkExp4 = (x: any): x is ThunkExp4 => x.tag === "ThunkExp4";
