...
import { CExp4, ThunkExp4 } from './L4-ast-box';
import { Env } from './L4-env-box';

// Add void for value of side-effect expressions - set! and define
export type Value4 = SExp4 | Closure4 | undefined | ThunkExp4;
...
export type SExp4 = number | boolean | string | PrimOp | Closure4 | SymbolSExp | EmptySExp | CompoundSExp4 | ThunkExp4;
